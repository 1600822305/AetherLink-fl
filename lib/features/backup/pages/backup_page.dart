...
class _WebDavSettingsSheetState extends State<_WebDavSettingsSheet> {
  ...
  void initState() {
    ...
    _pathCtrl = TextEditingController(text: widget.cfg.path.isEmpty ? 'aetherlink_backups' : widget.cfg.path);
  }
                  ...
                  _TactileTextButton(
                    ...
                    onTap: () async {
                      final newCfg = widget.cfg.copyWith(
                        ...
                        path: _pathCtrl.text.trim().isEmpty ? 'aetherlink_backups' : _pathCtrl.text.trim(),
                      );
