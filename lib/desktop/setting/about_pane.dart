              ...
              _DeskCard(
                ...
                children: [
                  ...
                  _DeskNavRow(
                    ...
                    onTap: () => _openUrl('https://aetherlink.psycheas.top/'),
                  ),
                  const _DeskRowDivider(),
                  _DeskNavRow(
                    icon: lucide.Lucide.Github,
                    label: 'GitHub',
                    onTap: () => _openUrl('https://github.com/Chevey339/aetherlink'),
                  ),
                  const _DeskRowDivider(),
                  _DeskNavRow(
                    icon: lucide.Lucide.FileText,
                    label: l10n.aboutPageLicense,
                    onTap: () => _openUrl('https://github.com/Chevey339/aetherlink/blob/master/LICENSE'),
                  ),
                  const _DeskRowDivider(),
                  _DeskNavRowSvg(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        const Text('AetherLink', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
...
Future<void> _showSponsorDesktopDialog(BuildContext context) async {
  ...
  final l10n = AppLocalizations.of(context)!;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  const afdianUrl = 'https://afdian.com/a/aetherlink';
