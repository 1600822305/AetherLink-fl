...
class _DesktopBackupPaneState extends State<DesktopBackupPane> {
  ...
  WebDavConfig _buildConfigFromForm() {
    return WebDavConfig(
      ...
      path: _path.text.trim().isEmpty ? 'aetherlink_backups' : _path.text.trim(),
  ...
  Future<void> _applyPartial({String? url, String? username, String? password, String? path, bool? includeChats, bool? includeFiles}) async {
    final cfg = WebDavConfig(
      ...
      path: path ?? (_path.text.trim().isEmpty ? 'aetherlink_backups' : _path.text.trim()),
                  ...
                  _ItemRow(
                    ...
                    trailing: SizedBox(
                      ...
                      child: TextField(
                        ...
                        enabled: !busy,
                        style: const TextStyle(fontSize: 14),
                        decoration: _deskInputDecoration(context).copyWith(hintText: 'aetherlink_backups'),
